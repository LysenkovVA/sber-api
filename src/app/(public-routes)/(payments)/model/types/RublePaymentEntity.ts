...
export const RublePaymentEntitySchema = z.object({
    ...
    // Данные НДС
    // Способ расчета НДС
    vatType: z.enum(["INCLUDED", "ONTOP", "NO_VAT", "MANUAL"]),
    // Ставка НДС
...
export type RublePaymentEntity = z.infer<typeof RublePaymentEntitySchema> & {
