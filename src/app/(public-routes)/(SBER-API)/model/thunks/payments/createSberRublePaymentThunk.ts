...
export const createSberRublePaymentThunk = createAsyncThunk<
    ResponseData<SberRublePaymentEntity | undefined>,
    CreateRublePaymentThunkProps,
    ThunkConfig<string>
>("createSberRublePaymentThunk", async (props, thunkApi) => {
    ...
    try {
        ...
        do {
            ...
            const rpp = (await response.json()) as ResponseData<
                SberRublePaymentEntity | undefined
            >;
